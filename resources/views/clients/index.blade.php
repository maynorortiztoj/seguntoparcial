        ...
        <table class="table-fixed w-full">
          <thead>
            <tr class="bg-indigo-500 text-white">
              ...
              <th class="w-1/16 py-4 ...">Direccion</th>
              <th class="w-1/16 py-4 ...">Telefono</th>
              <th class="w-1/16 py-4 ...">DPI</th>
          ...
          <tbody>
            <tr>
              ...
              <td class="p-3">Maynor</td>
              <td class="p-3 text-center">Ortiz</td>
              <td class="p-3 text-center">salama</td> 
              <td class="p-3 text-center">12345678</td>
              <td class="p-3 text-center">1234567</td>
              <td class="p-3">
